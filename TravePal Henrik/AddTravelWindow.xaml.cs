...
namespace TravePal_Henrik
{
    ...
    public partial class AddTravelWindow : Window
    {
        ...
        IPackingListItem autoGeneratedPassport = null;
        ...
        private void cmbCountry_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            if (autoGeneratedPassport != null)
            {
                PackingItems.Remove(autoGeneratedPassport);
                lstPackList.Items.Remove(autoGeneratedPassport);
            }
            ...
            object destination = e.AddedItems[0];
            object value = user.Location;


            // Assuming that 'value' and 'destination' are strings
            if (Enum.IsDefined(typeof(EuropeanCountry), value.ToString()) && Enum.IsDefined(typeof(EuropeanCountry), destination.ToString()))
            {
                autoGeneratedPassport = PackinItemManager.AddPackItem("Passport (is not required)", false);
            }

            else
            {
                autoGeneratedPassport = PackinItemManager.AddPackItem("Passport (is required)", true);
            }


            PackingItems.Add(autoGeneratedPassport);
            lstPackList.Items.Add(autoGeneratedPassport);
